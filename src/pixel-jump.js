...
Game.prototype.draw = function() {
  ...
  if(this.state == this.GAME_STATE.INTRO){
    ...
    this.ctx.strokeText("Squappy Jump", this.gameWidth/2, this.gameHeight/4);
    this.ctx.fillText("Squappy Jump", this.gameWidth/2, this.gameHeight/4);
...
Game.prototype.setColor = function(playerColor,worldColor,backgroundColor,textColor){
  ...
  this.worldColor = (typeof(worldColor) == 'string' && worldColor.length == 7) ? worldColor : "#eac4d5";
  this.backgroundColor = (typeof(backgroundColor) == 'string' && backgroundColor.length == 7) ? backgroundColor : "#eac4d5";
